...
public class SensitiverFilter {
    ...
    private static final Logger logger = LoggerFactory.getLogger(SensitiverFilter.class);
    //替换符
    ...
    @PostConstruct
    public void init() {
        try(InputStream is = this.getClass().getClassLoader().getResourceAsStream("sensitive-words.txt");//这个地方你的地址写错了
    ...
    private class TrieNode{
        ...
        private Map<Character,TrieNode> subNodes = new HashMap<>(); //节点对应字符
